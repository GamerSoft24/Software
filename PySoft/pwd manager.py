...
import time
length = 20
name = input("Enter your name as this program is in security level 10 mode. (It will be kept private throughout entire your session and you can learn more about it with option 4): ")
time.sleep(3)
print("")
print("Hello" + " " + name + ". " + "You have been confirmed you are not a bot!")
print("")
time.sleep(2)
flag = True
while flag == True:
    ...
    if option == 1:
        ...
        print("")
        input("About this program's security: ")
        print("")
        print("As this program is a Password Manager Security System, this program will ask your name at every prompt to ensure that it is a human and not a bot.")
        input("You have been informed that this program is in security level 10 mode. Here is a closer look about security levels: ")
        print("")
        ...
        print("")
        print("The more stronger the level is, the more security questions and tests it will require. ")
        print("In this case, with level 10 security, this program will be running test on your PC's informations, SSH, IPv4 and IPv6 addresses (in a way so that your informations are kept secure) while you have entered your name. ")
        print("")
