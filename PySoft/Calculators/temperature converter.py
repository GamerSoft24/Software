...
option = int(input("Select option: "))
  if option == 1:
    celsiu1s = float(input('Enter a temperature in Celsius: '))
  ...
  if option == 5:
    ...
    kelvin5 = (fahenheit5 - 32) * 5 / 9 + 273.15
    print(fahrenheit5,'degrees Fahrenheit is',kelvin5,'degrees Kelvin.')
  if option == 6:
    kevlin6 = float(input('Enter a temperature in Kelvin: '))
