...
echo [3] BRSTD1 - Browser Standard 1 (Default Setup).
echo [4] BRSTD1 - Browser Standart 1 (Advanced Setup).
echo [5] Quit program.
...
set /p username_session="Enter your session's username (can be found with the command 'whoami' in the Windows Command Prompt (cmd.exe)): "
...
:BRSTD1_ADVANCED
cls
set /p chrome_path="Enter your Google browser path (e.g: C:\Progra~2\Google\Chrome\Application\chrome.exe): "
set /p userdata_dir_path="Enter the UserData DIR path: "
set /p version_chrome="Enter Chrome version to open (any number from 1-current release, e.g. 86, 120, 121,...): "
